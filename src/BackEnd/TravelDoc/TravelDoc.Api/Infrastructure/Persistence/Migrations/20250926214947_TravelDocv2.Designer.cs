...
namespace TravelDoc.Api.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250926214947_TravelDocv2")]
    partial class TravelDocv2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelDoc.Infrastructure.Core.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TravelDoc.Api.Domain.Viagens.Entities.Viagem", b =>
                {
                    b.HasOne("TravelDoc.Application.Usuarios.Domain.Usuario", "Criador")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_viagem_tb_usuario_tb_criador_id");
            ...
            modelBuilder.Entity("TravelDoc.Infrastructure.Core.Events.Event", b =>
                {
                    b.HasOne("TravelDoc.Api.Domain.Viagens.Entities.Viagem", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_event_viagem_tb_viagem_id");
                });
